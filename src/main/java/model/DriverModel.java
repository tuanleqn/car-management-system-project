...
public class DriverModel {
    ...
    public String toString() {
        return "DriverModel [DriverID=" + DriverID + ", FullName=" + FullName + ", Phone=" + Phone + ", Address=" + Address + ", DLNumber=" +DLNumber+", status=" + status + "]";
    }
    @Override
    public int hashCode() {
...
public class DriverModel {
	...
	public DriverModel(String driverID, String fullName, String phone, String address, String dlNumber,
			DriverStatus status) {
		this.DriverID = driverID;
		this.FullName = fullName;
		this.Phone = phone;
	...
	@Override
	public String toString() {
		return "DriverModel [DriverID=" + DriverID + ", FullName=" + FullName + ", Phone=" + Phone + ", Address="
				+ Address + ", DLNumber=" + DLNumber + ", status=" + status + "]";
	}
